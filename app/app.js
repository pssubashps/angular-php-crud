...
app.controller('editCtrl', function ($scope, $rootScope, $location, $routeParams, services, customer) {
    ...
    $rootScope.title = (customerID > 0) ? 'Edit Question' : 'Add Question';
    $scope.buttonText = (customerID > 0) ? 'Update Question' : 'Add New Question';
      ...
      $scope.deleteCustomer = function(customer) {
        $location.path('/');
        if(confirm("Are you sure to delete question : "+$scope.customer._id)==true)
